  ...
  return (
    <section className="py-20 bg-[#FAFAF8]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Horizontally Scrollable Instagram Posts */}
        <ScrollReveal delay={150}>
          ...
          >
            {posts.map((img, idx) => (
              <div
                key={idx}
                className="flex-none w-[200px] sm:w-[240px] md:w-[260px] scroll-snap-item relative h-64 sm:h-72 rounded-xl overflow-hidden group bg-[#F7F4EF] luxury-card"
              >
                <Image
                  src={img}
